    ...
    <div>
      ...
      <div className='shopCards grid grid-cols-2'>
...

        {
          ...
          //   <h2>We're sorry, we couldn't find any search results. Please check your spelling or try a different search term. You could also browse brands in our A-Z brands page or take a look at some of the product links in the menu above.</h2>
          // </div>
          // products.map((item, index) => {
          //   item.quantity = 1
          //   return (
