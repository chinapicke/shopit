      ...
      <div className='innerCartPage'>
        ...
        {state.length > 0 && (
          <>
            ...
            <div className="checkout py-2 px-2 flex flex-col items-center text-center mt-5 mx-1 md:grid grid-cols-2 md:justify-center">
              <p className="promotionNormal text-center mb-2 mt-3">Add <span className="promotionBold">promotion codes, </span> <span  className="promotionBold">gift vouchers </span>
                and <span  className="promotionBold">gifting</span> options at checkout</p>
              <button className="flex flex-row checkoutBtn bg-black py-2 px-2 rounded-md md:w-64 md:justify-center md:items-center md:ml-5">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" className="w-5 h-5 mr-2">
                  <path fillRule="evenodd" d="M10 1a4.5 4.5 0 00-4.5 4.5V9H5a2 2 0 00-2 2v6a2 2 0 002 2h10a2 2 0 002-2v-6a2 2 0 00-2-2h-.5V5.5A4.5 4.5 0 0010 1zm3 8V5.5a3 3 0 10-6 0V9h6z" clipRule="evenodd" />
                </svg>
                <p className='text-end'>Continue checkout</p>
              </button>
            </div>
            </div>
          </>
