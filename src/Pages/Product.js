          ...
          <div id={singleProduct.id} className='productPageCard relative ml-2 mr-8 md:grid grid-cols-2'>
            ...
            <div >
                ...
                {likedIndex ?
                  (
                    <>
                      ...
                      <h1 className='heartIconCaption mx-2'>add to favourites</h1>
                    </>
                  ) : (
                    <>
              ...
              <div className='flex flex-row pb-3 justify-between'>
                <h2 className='productPrice mt-4'> <span className='circleShadowProductPg '>£{singleProduct.price === '0.0' || singleProduct.price === null ? '8.50' : Number(singleProduct.price).toFixed(2)}</span></h2>
