...
// Need to change so colour changes
  // const handleColour = () => {
  //   setClickedColour(false)
      ...
      <div className='productInfo'>
        ...
        {isLoading ?
          ...
          <div id={singleProduct.id} className='productPageCard relative ml-2 mr-8 md:grid grid-cols-2'>
            ...
            <div>
            {/* < button className='mx-1 my-1' value={singleProduct.brand + singleProduct.product_type} onClick={() => { changeIcon(); saveDispatch({ type: 'SAVE', saveIt: singleProduct }) }}>
                {likedIndex ?
                  (
