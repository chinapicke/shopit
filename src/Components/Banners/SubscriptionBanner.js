        ...
        <div className='subscriptionBanner'>
            ...
            <form className="w-full max-w-sm">
                <div className="flex items-center border-b border-black py-2">
                    <input className="appearance-none bg-transparent border-none w-full text-black mr-3 py-1 px-2 leading-tight focus:outline-none placeholder-black" type="email" placeholder="Your email"  />
                    <input className='subscriptionBtn' type="submit" value="Submit"></input>
