  ...
  return (
    ...
    <div className='homepageBottomBanner grid grid-cols-2 mx-0 md:mx-20 my-3'>
      <div>
        ...
        <button onClick={BtnDirectShop} className='productsSeeBtn text-xs bg-black text-white px-2 my-2 mb-0 md:my-6 ml-2 text-sm py-4 px-6 rounded-full mr-auto lg:text-lg' type="button">See more</button>
      </div>
      <div>
